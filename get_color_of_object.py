...
def get_color_of_object(image, hsv_image):
    ...
    cv2.createTrackbar('H Low', win_name,0,255,nothing)
    cv2.createTrackbar('H High', win_name,11,255,nothing)
    cv2.createTrackbar('S Low', win_name,90,255,nothing)
    cv2.createTrackbar('S High', win_name,255,255,nothing)
    cv2.createTrackbar('V Low', win_name,187,255,nothing)
    ...
    while(1):
        ...
        mask = cv2.inRange(hsv_image,HSVLOW, HSVHIGH)
